<?php
    ...
    if ( ! class_exists( 'Redux_Framework_CM_config' ) ) {

        class Redux_Framework_CM_config {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'callback' => array( 'Redux_Framework_CM_config', 'class_field_callback' )
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'display_name'         => 'WP Curriculum Manager',
                    ...
                    'menu_title'           => __( 'WP Curriculum', 'redux-framework-demo' ),
                    'page_title'           => __( 'WP Curriculum', 'redux-framework-demo' ),
        ...
        global $reduxConfig;
        $reduxConfig = new Redux_Framework_CM_config();
    } else {
        echo "The class named Redux_Framework_CM_config has already been called. <strong>Developers, you need to prefix this class with your company name or you'll run into problems!</strong>";
    }
